...
public class Config {
    ...
    private int bodySuppliers = 5;
    private int engineSuppliers = 5;
    private int workers = 10;
    private int dealers = 20;
    private boolean logSale = false;
    private int supplierMinDelay = 500;
    ...
    private void loadProperties() {
        ...
        bodySuppliers = getIntProperty("BodySuppliers", bodySuppliers);
        engineSuppliers = getIntProperty("EngineSuppliers", engineSuppliers);
    ...
    public int getBodySuppliers() { return bodySuppliers; }
    public int getEngineSuppliers() { return engineSuppliers; }
    public int getWorkers() { return workers; }
    public int getDealers() { return dealers; }
    public boolean isLogSale() { return logSale; }
    public int getSupplierMinDelay() { return supplierMinDelay; }
    public int getSupplierMaxDelay() { return supplierMaxDelay; }
    public int getDealerMinDelay() { return dealerMinDelay; }
    public int getDealerMaxDelay() { return dealerMaxDelay; }
}